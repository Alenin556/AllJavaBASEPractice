...
public class EmployeeB {
    ...
    public static class EmployeeBuilder {
        ...
        //Build the Builder.EmployeeB object
...
class TestBuilder {
    public static void main(String[] args) {
        EmployeeB employee = new EmployeeB.EmployeeBuilder("Andrew", "Aston").setHasBike(false).setHasCar(true).build();
        System.out.println(employee.getCompany());
        System.out.println(employee.isHasCar());
    }
}
